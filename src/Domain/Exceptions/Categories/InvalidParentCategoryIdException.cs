...
{
    public class InvalidParentCategoryIdException : DomainException
    {
        internal InvalidParentCategoryIdException(CategoryId parentCategoryId) : base(
            $"Invalid parent category id. {parentCategoryId}")
        {
        }

        public override string Code { get; } = ErrorCodes.InvalidParentCategoryId;
    }
}